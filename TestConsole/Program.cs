...
class Program
{
    ...
    {
        string filePath1 = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "TestFiles", "sample.pdf");
        string filePath2 = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "TestFiles", "sample - Copy.pdf");
        ...
        var payload = new
        {
            ...
            {
                new { base64 = base64Content1, fileName = "sample.pdf" },
                new { base64 = base64Content2, fileName = "sample - Copy.pdf" }
            }
        };
